...
import Ventanas_Secundarias.Empleados_Registrados;
import static Ventana_Principales.Ventana_Admin.Contenido;
import Ventanas_Secundarias.Empleados_Actualizar;
import Ventanas_Secundarias.Empleados_Agregar;
import Ventanas_Secundarias.Empleados_Eliminar;
...
public class Empleados extends javax.swing.JPanel {
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
        ...
        Contenido.removeAll();
        Contenido.add(emp, BorderLayout.CENTER);
        Contenido.revalidate();
        Contenido.repaint();
    ...
    private void RegistradosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistradosMousePressed
        ...
        Contenido.removeAll();
        Contenido.add(empr, BorderLayout.CENTER);
        Contenido.revalidate();
        Contenido.repaint();
