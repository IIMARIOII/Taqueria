...
import Ventanas_Secundarias.Facturas_Actualizar;
import Ventanas_Secundarias.Facturas_Agregar;
import Ventanas_Secundarias.Facturas_Eliminar;
import Ventanas_Secundarias.Facturas_Registrados;
...
public class Facturas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Actualizar Factura");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Eliminar_fact.png"))); // NOI18N
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 10, 100, 120));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fact_up.png"))); // NOI18N
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 130, 120));
    ...
    private void AgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarMousePressed
        ...
        Contenido.removeAll();
        Contenido.add(fa, BorderLayout.CENTER);
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
       // ABRE LA SECCION 
        Facturas_Eliminar fe = new Facturas_Eliminar();
        fe.setSize(860, 560);
        fe.setLocation(0,0);
        
        Contenido.removeAll();
        Contenido.add(fe, BorderLayout.CENTER);
        Contenido.revalidate();
        Contenido.repaint();
    ...
    private void RegistradosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistradosMousePressed
        ...
        Contenido.removeAll();
        Contenido.add(fr, BorderLayout.CENTER);
        Contenido.revalidate();
        Contenido.repaint();
    ...
    private void ActualizarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMousePressed
        // ABRE LA SECCION 
        Facturas_Actualizar fr = new Facturas_Actualizar();
        fr.setSize(860, 560);
        fr.setLocation(0,0);
