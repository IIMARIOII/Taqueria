...
import Ventanas_Secundarias.Ordenes_Actualizar;
import Ventanas_Secundarias.Ordenes_Agregar;
import Ventanas_Secundarias.Ordenes_Eliminar;
import Ventanas_Secundarias.Ordenes_Registrados;
import Ventanas_Secundarias.Pedidos_Agregar;
import Ventanas_Secundarias.Pedidos_Eliminar;
import Ventanas_Secundarias.Pedidos_Registrados;
...
public class Ordenes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Actualizar Orden");
    ...
    private void ActualizarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMousePressed
       // ABRE LA SECCION 
        Ordenes_Actualizar pr = new Ordenes_Actualizar ();
        pr.setSize(860, 560);
        pr.setLocation(0,0);
