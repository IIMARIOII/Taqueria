...
public class Ventana_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));
    ...
    private void btn_FacturasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_FacturasMousePressed
        ...
        Contenido.removeAll();
        Contenido.add(fac, BorderLayout.CENTER);
        Contenido.revalidate();
        Contenido.repaint();
