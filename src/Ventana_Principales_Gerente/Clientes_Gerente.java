...
import Ventanas_Secundarias_Gerente.Clientes_Actualizar;
import Ventanas_Secundarias_Gerente.Clientes_Agregar;
import Ventanas_Secundarias_Gerente.Clientes_Eliminar;
import Ventanas_Secundarias_Gerente.Clientes_Registrados;
import java.awt.BorderLayout;
import java.awt.Color;
import javax.swing.JPanel;


public class Clientes_Gerente extends javax.swing.JPanel {

    
    public Clientes_Gerente() {
        initComponents();
    }
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
       // ABRE LA SECCION 
        ...
        Contenido_Gerente.removeAll();
        Contenido_Gerente.add(ce, BorderLayout.CENTER);
        Contenido_Gerente.revalidate();
        Contenido_Gerente.repaint();
    ...
    private void RegistradosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistradosMousePressed
        ...
        Contenido_Gerente.removeAll();
        Contenido_Gerente.add(cr, BorderLayout.CENTER);
        Contenido_Gerente.revalidate();
        Contenido_Gerente.repaint();
    ...
    private void ActualizarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMousePressed
        ...
        Contenido_Gerente.removeAll();
        Contenido_Gerente.add(cact, BorderLayout.CENTER);
        Contenido_Gerente.revalidate();
        Contenido_Gerente.repaint();
