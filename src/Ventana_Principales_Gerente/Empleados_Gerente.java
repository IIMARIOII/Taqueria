...
import Ventanas_Secundarias_Gerente.Empleados_Actualizar;
import Ventanas_Secundarias_Gerente.Empleados_Agregar;
import Ventanas_Secundarias_Gerente.Empleados_Eliminar;
import Ventanas_Secundarias_Gerente.Empleados_Registrados;
...
public class Empleados_Gerente extends javax.swing.JPanel {

    
    public Empleados_Gerente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido al Apartado De Empleados");
        ...
        Registrados.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Eliminar_User.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Agregar_User_1.png"))); // NOI18N
    ...
    private void AgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarMousePressed
        /////ABRIR SECCION DE AGREGAR EMPLEADOS//////
        Empleados_Agregar p1 = new Empleados_Agregar();
        p1.setSize(860, 560);
        p1.setLocation(0,0);
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
        /////ABRIR SECCION DE ELIMINAR EMPLEADOS//////
        Empleados_Eliminar emp = new Empleados_Eliminar();
        emp.setSize(860, 560);
        emp.setLocation(0,0);
        
        Contenido_Gerente.removeAll();
        Contenido_Gerente.add(emp, BorderLayout.CENTER);
        Contenido_Gerente.revalidate();
        Contenido_Gerente.repaint();
    ...
    private void RegistradosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistradosMousePressed
        /////ABRIR SECCION DE  EMPLEADOS//////
        Empleados_Registrados empr = new Empleados_Registrados();
        empr.setSize(860, 560);
        empr.setLocation(0,0);
        
        Contenido_Gerente.removeAll();
        Contenido_Gerente.add(empr, BorderLayout.CENTER);
        Contenido_Gerente.revalidate();
        Contenido_Gerente.repaint();
    ...
    private void ActualizarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMousePressed
        /////ABRIR SECCION DE  EMPLEADOS//////
        Empleados_Actualizar empr = new Empleados_Actualizar();
        empr.setSize(860, 560);
        empr.setLocation(0,0);
