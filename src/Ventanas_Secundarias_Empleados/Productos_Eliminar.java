...
public class Productos_Eliminar extends javax.swing.JPanel {
    IniciarSesion_BD bd = new IniciarSesion_BD();
   
    public Productos_Eliminar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblEE.setText("Eliminar Producto");
        ...
        txt_id.setText("Ingrese el ID del Producto");
        ...
        p.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Productos", "Nombre Producto", "Descripcion", "Precio"
            }
        ) {
    ...
    private void txt_idMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_idMousePressed
        if(txt_id.getText().equals("Ingrese el ID del Producto"))
        txt_id.setText("");
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
        ...
        if(bd.existeProducto(txt_id.getText())==0){
            JOptionPane.showMessageDialog(null, "El ID del Producto no existe");
        }else{
      
        String id = txt_id.getText();
        if(id.equals("Ingrese el ID del Producto a Eliminar")||id.equals("")){
            JOptionPane.showMessageDialog(null, "Por Favor Digite el ID del Producto");
        }else{
            ...
            if(pregunta==0){
                ...
                Eliminar.eliminarProducto(value);
                JOptionPane.showMessageDialog(this, "El producto fue eliminado exitosamente");
                }
            }
        }
      }
