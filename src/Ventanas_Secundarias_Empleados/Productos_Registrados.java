 ...
 * @author leone
 */
public class Productos_Registrados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ProductosR = new javax.swing.JTable();
        ...
        lblNombre.setText("Productos 1256454545645");
        jPanel2.add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, -1));

        ProductosR.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        ProductosR.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        ProductosR.setSelectionBackground(new java.awt.Color(0, 102, 255));
        jScrollPane1.setViewportView(ProductosR);
    ...
    private void RegresarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegresarMousePressed
        ...
        Productos_Empleados p1 = new Productos_Empleados();
        p1.setSize(860, 560);
        p1.setLocation(0,0);
    ...
    private javax.swing.JTable ProductosR;
