...
public class Ordenes_Eliminar extends javax.swing.JPanel {
    IniciarSesion_BD bd = new IniciarSesion_BD();
   
    public Ordenes_Eliminar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Eliminar Orden");
        ...
        lblEE.setText("Eliminar Orden");
        Eliminar.add(lblEE, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, -1));
        ...
        txt_id.setText("Ingrese el ID de la Orden a Eliminar");
    ...
    private void RegresarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegresarMousePressed
        ...
        Ordenes_Gerente p1 = new Ordenes_Gerente();
        p1.setSize(860, 560);
        p1.setLocation(0,0);
    ...
    private void txt_idMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_idMousePressed
        if(txt_id.getText().equals("Ingrese el ID de la Orden a Eliminar"))
        txt_id.setText("");
    ...
    private void EliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMousePressed
       //Metodo Para eliminar el Pedido Registrado dentro de la base de datos
        if(bd.existeOrden(txt_id.getText())==0){
            JOptionPane.showMessageDialog(null, "El ID de la orden no existe");
        }else{
      
        String id = txt_id.getText();
        if(id.equals("Ingrese el ID de la Orden a Eliminar")||id.equals("")){
            JOptionPane.showMessageDialog(null, "Por Favor Digite el ID de la Orden");
        }else{
